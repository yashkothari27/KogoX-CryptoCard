    ...
    <section id="security" className="py-20 lg:py-32 relative">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <ScrollReveal>
              <span className="text-primary/90 font-medium text-sm uppercase tracking-wider">Security & Trust</span>
            </ScrollReveal>
              ...
              {securityFeatures.map((feature, index) => (
                <ScrollReveal key={index} delayMs={Math.min(index * 70, 210)}>
                  <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center shrink-0 border border-white/5">
          ...
          <div className="relative flex justify-center">
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-40 h-40 rounded-full bg-gradient-to-br from-primary/18 via-primary/12 to-[#8a6b1f]/14 flex items-center justify-center">
