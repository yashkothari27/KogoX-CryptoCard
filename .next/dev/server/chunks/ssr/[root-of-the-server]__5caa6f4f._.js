...
;
const metadata = {
    title: "KogoX Crypto Card | Spend Crypto Anywhere",
    description: "KogoX Crypto Card - Spend your crypto easily worldwide with instant and seamless payments. Global card acceptance at millions of merchants.",
    generator: "v0.app",
    icons: {
        icon: [
            {
